...
const initializeLogin = async (rollNumber, password) => {
    ...
    const fetchCookies = async () => {
        return await axios.get("https://studentportal.hindustanuniv.ac.in/home.htm").then((res) => {
    ...
    const authorizeCookies = async (cookieString) => {
        ...
        return await axios.post("https://studentportal.hindustanuniv.ac.in/home.htm", formData, {
            headers: {
                Cookie: cookieString
            },
    ...
    // console.log(await authorizeCookies(cookieString))
